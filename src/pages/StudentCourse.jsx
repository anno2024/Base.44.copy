...
export default function StudentCourse() {
  ...
  const { data: flashcards = [] } = useQuery({
    ...
    queryFn: () =>
      base44.entities.Flashcard.filter({ course_id: courseId, shared: true }),
    enabled: !!courseId,
  });
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="mb-8">
          <Link
            ...
            className="inline-flex items-center text-slate-500 hover:text-slate-700 mb-4 group"
          >
                    ...
                    <div className="flex-1 flex items-center justify-center">
                      <div className="text-center">
                        ...
                        <p className="text-slate-500 mb-6 max-w-sm">
                          Get personalized help with course material. Ask
                          questions, get hints, and deepen your understanding.
                        </p>
                        <Button
                          onClick={startNewChat}
                                        ...
                                        <div className="mt-3 pt-3 border-t border-slate-200">
                                          ...
                                          <ul className="text-xs text-slate-600 space-y-1">
                                            {msg.citations.map((citation) => (
                                              <li
                                                key={`${citation.id}-${citation.source}-${citation.page ?? "na"}`}
                                              >
                                                [{citation.id}]{" "}
                                                {citation.source}
          ...
          <TabsContent value="flashcards">
            {flashcards.length === 0 ? (
              ...
              <div>
                <Link
                  to={
                    createPageUrl("StudyFlashcards") + `?courseId=${courseId}`
                  }
                >
